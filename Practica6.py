...
aux = input("Entra la n(0-3) (excriu stop per acabar): ")
...
while aux != "stop":
    ...
    iY2d = iY2.doit()
    iY2v = iY2d.evalf()
    print("La probabilitat de trobar la particula en X0 = " + str(a) + " i el punt X1 " + str(b) + " amb n = " + str(nwave+1) + " és " + str(abs(iY2v)*100) + "%.")
    aux = input("Entra la n(0-3): ")
